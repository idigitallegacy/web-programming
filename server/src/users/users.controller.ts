      ...
      case "vk": {
        ...
        this.httpService.get(request_string).pipe(
          ...
          switch (process.env.ENVIRONMENT) {
            ...
            case "PROD": {
              response.cookie("vk_access_token", exchangedToken.response.access_token, { maxAge: exchangedToken.response.expires_in, secure: true, httpOnly: true, domain: "web-y25-makarov.onrender.com", sameSite: "strict", path: "/" });
              break
            }
          }
